...
def on_epoch_end(epoch, _):
    ...
    for diversity in [0.2, 0.5, 1.0, 1.2, 1.5, 2.0]:
        ...
        for i in range(1000):
            ...
            generated+=next_char
        file_path=f"generated_conversations/Epoch-{epoch}"
        if not os.path.exists("generated_conversations"):
            os.makedirs("generated_conversations")
        if not os.path.exists(f"generated_conversations/Epoch-{epoch}"):
            os.makedirs(f"generated_conversations/Epoch-{epoch}")
